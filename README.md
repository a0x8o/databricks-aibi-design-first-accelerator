...
For the master-led v2 chain in Genie Code, the Agentic App, or another agent, see
[Portable v2 execution and migration](docs/v2-portable-execution.md).
...
```
Execute the master prompt at /Workspace/Users/<you>/aibi-design-first-accelerator/framework/agent_skills/v2/prompts/00_master_prompt.md with EXAMPLE_DIR /Workspace/Users/<you>/aibi-design-first-accelerator/kpi_domains/member_claims — run end to end.
```
...
Genie pipeline: `framework/agent_skills/v2/prompts/00_master_prompt.md` → steps `01`–`06`. Details: [Design guide](docs/design.md).
