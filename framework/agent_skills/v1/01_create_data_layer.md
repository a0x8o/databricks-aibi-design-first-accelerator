...
> 2. `{AGENT_SKILLS_DIR}/guardrails/01_data_layer_guardrails.md` (THIS step's gates, rules, and anti-patterns)
> 3. `{AGENT_SKILLS_DIR}/guardrails/sql_generation_rules.md` (ALL SQL generation — DDL, queries, validation)
>
