...
> 1. `{AGENT_SKILLS_DIR}/guardrails/00_global_rules.md` (ALWAYS — every step)
> 2. `{AGENT_SKILLS_DIR}/guardrails/04_genie_guardrails.md` (THIS step's gates, rules, and anti-patterns)
> 3. `{AGENT_SKILLS_DIR}/guardrails/sql_generation_rules.md` (ALL SQL generation — example SQL, benchmark SQL, MEASURE() queries)
>
