...
> 2. `{AGENT_SKILLS_DIR}/guardrails/02_metric_view_guardrails.md` (THIS step's gates, rules, and anti-patterns)
> 3. `{AGENT_SKILLS_DIR}/guardrails/sql_generation_rules.md` (ALL SQL generation — metric view DDL, validation queries)
>
