...
> 2. `{AGENT_SKILLS_DIR}/guardrails/03_dashboard_guardrails.md` (THIS step's gates, rules, and anti-patterns)
> 3. `{AGENT_SKILLS_DIR}/guardrails/sql_generation_rules.md` (ALL SQL generation — dataset queries, validation SQL)
>
