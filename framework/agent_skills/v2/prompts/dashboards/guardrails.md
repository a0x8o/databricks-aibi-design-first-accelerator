...
20. DO NOT use `spark.sql()` — see **G-13** in `{AGENT_SKILLS_DIR}/prompts/shared/global_guardrails.md`
...
21. DO NOT set `PARENT_PATH` to user home root — see **G-14** in `{AGENT_SKILLS_DIR}/prompts/shared/global_guardrails.md`
