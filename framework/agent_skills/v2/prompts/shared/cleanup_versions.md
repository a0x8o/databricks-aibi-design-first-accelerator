...
> **Always load:** `{AGENT_SKILLS_DIR}/prompts/shared/global_guardrails.md` and `{AGENT_SKILLS_DIR}/prompts/shared/state_contract.md`.
> **Failure-only:** do not load `{AGENT_SKILLS_DIR}/prompts/shared/cleanup_runbook.md` until an exact cleanup failure is
...
Do not load `{AGENT_SKILLS_DIR}/prompts/shared/cleanup_runbook.md` before a cleanup failure. After classifying an exact
