...
**Root cause:** Agent skipped reading `documentation/instructions.md` entirely.
...
**Fix:** Source the decision from `metric_views/resolved_metric_view_capabilities.yaml`, record its version/hash and policy scope, and reconcile it with verified generation/readback results.
