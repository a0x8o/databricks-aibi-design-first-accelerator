...
1. `shared/global_guardrails.md`;
2. `shared/state_contract.md`;
...
Apply the field-scoped G-3 hierarchy in `shared/global_guardrails.md`:
...
compare-and-swap, checkpoint, and invalidation rules in `shared/state_contract.md` are binding.
...
checkpoint in `metric_views/instructions.md`. For `explicit`, Step-0 identities remain immutable.
...
run_context.inputs.stage_prompts:
  create_data_layer: <data_layer/instructions.md>
  create_metric_views: <metric_views/instructions.md>
  create_dashboards: <dashboards/instructions.md>
  create_genie_space: <genie/instructions.md>
  generate_documentation: <documentation/instructions.md>
```
...
run_context.inputs.stage_validations:
  create_data_layer: <data_layer/validation.md>
  create_metric_views: <metric_views/validation.md>
  create_dashboards: <dashboards/validation.md>
  create_genie_space: <genie/validation.md>
  generate_documentation: <documentation/validation.md>
run_context.inputs.stage_guardrails:
  create_data_layer: <data_layer/guardrails.md>
  create_metric_views: <metric_views/guardrails.md>
  create_dashboards: <dashboards/guardrails.md>
  create_genie_space: <genie/guardrails.md>
  generate_documentation: <documentation/guardrails.md>
```
...
run_context.inputs.stage_runbooks:
  create_data_layer: {path: <data_layer/runbook.md>, version: 1, sha256: <raw digest>}
  create_metric_views: {path: <metric_views/runbook.md>, version: 1, sha256: <raw digest>}
  create_dashboards: {path: <dashboards/runbook.md>, version: 1, sha256: <raw digest>}
  create_genie_space: {path: <genie/runbook.md>, version: 1, sha256: <raw digest>}
  generate_documentation: {path: <documentation/runbook.md>, version: 1, sha256: <raw digest>}
```
...
run_context.inputs.orchestration_prompts:
  cross_validate_run:
    path: <exact cross_validation/instructions.md path>
    version: 1
    sha256: <SHA-256 of exact raw bytes>
    validation_path: <exact cross_validation/validation.md path>
    validation_sha256: <SHA-256 of exact raw bytes>
    guardrails_path: <exact cross_validation/guardrails.md path>
    guardrails_sha256: <SHA-256 of exact raw bytes>
    runbook_path: <exact cross_validation/runbook.md path>
    runbook_version: 1
    runbook_sha256: <SHA-256 of exact raw bytes>
run_context.inputs.shared_runbooks:
  state_recovery: {path: <shared/state_runbook.md>, version: 1, sha256: <raw digest>}
  cleanup: {path: <shared/cleanup_runbook.md>, version: 1, sha256: <raw digest>}
```
...
|---:|---|---|---|
| 2 | `create_data_layer` | `data_layer/instructions.md` | environment and source/bootstrap contracts |
| 3 | `create_metric_views` | `metric_views/instructions.md` | data contracts and current catalog reality |
| 4 | `create_dashboards` | `dashboards/instructions.md` | authenticated Metric View plan/validation/handoff/readback |
| 5 | `create_genie_space` | `genie/instructions.md` | authenticated Metric View plan/validation/handoff/readback |
| 6 | terminal sweep | `cross_validation/instructions.md` | all enabled creation branches terminal |
| 7 | `generate_documentation` | `documentation/instructions.md` | sweep result or failure-reporting eligibility |
...
2. load `cross_validation/instructions.md`, `cross_validation/validation.md`, and
   `cross_validation/guardrails.md` with shared global guardrails and the state contract; keep its
   runbook unloaded;
...
On a classified sweep failure only, authenticate `cross_validation/runbook.md` and load the section
...
in authenticated `documentation/instructions.md`; its draft uses the same field names and shapes but
...
critical tool failure defined by `shared/state_contract.md`, stop immediately. Report the exact
